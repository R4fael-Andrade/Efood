...
export const informations: DishClass[] = [
    {
        id: 1,
        title: 'Hioki Sushi ',
    ...
    },
    {
        ...
        description: 'A La Dolce Vita Trattoria leva a autêntica cozinha italiana até você! Desfrute de massas caseiras, pizzas deliciosas e risotos incríveis, tudo no conforto do seu lar. Entrega rápida, pratos bem embalados e sabor inesquecível. Peça já o seu e prove!',
        assessment: '4.6',
        image: macarronada,
        infos: ['Italiana']
    },
    {
        ...
        description: 'Deliciosa combinação de fatias generosas de calabresa temperada, cebolas frescas, orégano e queijo derretido sobre uma massa crocante, assada à perfeição. Sabor clássico e irresistível que você irá amar!',
        assessment: '4.8',
        image: calabresa,
        infos: ['Pizza']
    },
    {
        ...
        assessment: '4.9',
        image: massaCozida,
        infos: ['Italiana', 'Mais pedidos']
    },
    {
        id: 5,
        title: 'Lasanha à Bolonhesa',
        description: 'Camadas generosas de massa fresca intercaladas com um rico molho de carne bolonhesa, molho de tomate caseiro e uma cobertura gratinada de queijo derretido!',
        assessment: '4.5',
        image: lasanha,
        infos: ['Massas']
    },
